...
import { createTag, dirty, combine, COMPUTE, ConstReference, createUpdatableTag, isConst, update, validate, value, CONSTANT_TAG, CachedReference, map, CURRENT_TAG, isConstTag } from '@glimmer/reference';
...
if (DEBUG) {
  ...
  let DebugStackImpl = class DebugStackImpl {
    constructor() {
      this._stack = [];
    }
...
class Environment$1 extends Environment {
  constructor(injections) {
    ...
    if (DEBUG) {
      this._debugStack = getDebugStack$1();
    }
...
export { RootTemplate, template, counters as templateCacheCounters, Checkbox, TextField, TextArea, LinkComponent, Component, ROOT_REF, Helper, helper, Environment$1 as Environment, SafeString, escapeExpression, htmlSafe, isHTMLSafe, Renderer, InertRenderer, InteractiveRenderer, _resetRenderers, renderSettled, getTemplate, setTemplate, hasTemplate, getTemplates, setTemplates, setupEngineRegistry, setupApplicationRegistry, registerMacros as _registerMacros, experimentalMacros as _experimentalMacros, AbstractManager as AbstractComponentManager, UpdatableReference, INVOKE, iterableFor, getDebugStack$1 as getDebugStack, OutletView, capabilities, setComponentManager, getComponentManager, setModifierManager, getModifierManager, capabilities$1 as modifierCapabilities, setComponentTemplate, getComponentTemplate };
